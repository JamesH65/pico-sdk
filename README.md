...
See [Getting Started with the Raspberry Pi Pico](https://raspberrypi.github.io/pico-sdk-doxygen) for information on how to setup your
hardware, IDE/environment and for how to build and debug software for the Raspberry Pi Pico
and other RP2040 based devices.

See [Pico C/C++ SDK](https://datasheets.raspberrypi.org/pico/sdk/pico_c_sdk.pdf) to learn more about programming using the
SDK, exploring more advanced features, and complete PDF based API documentation.

See [Online Raspberry Pi Pico SDK API docs](https://raspberrypi.github.io/pico-sdk-doxygen) for HTML based API documentation.
...
instructions for other platforms, and just in general, we recommend you see [Pico C/C++ SDK](https://datasheets.raspberrypi.org/pico/sdk/pico_c_sdk.pdf)
...
4. Write your code (see [pico-examples](https://github.com/raspberrypi/pico-examples) or the [Pico C/C++ SDK](https://datasheets.raspberrypi.org/pico/sdk/pico_c_sdk.pdf) documentation
